...
export function NewHabitForm() {
  ...
  return (
    <form onSubmit={createNewHabit} className="w-full flex flex-col mt-6">
      ...
      <label htmlFor="title2" className="font-semibold leading-tight mt-4">
        Qual a recorrência?
      </label>
      ...
      <button
        type="submit"
        className="mt-6 rounded-lg p-4 flex justify-center items-center gap-3 font-semibold bg-green-600"
      >
